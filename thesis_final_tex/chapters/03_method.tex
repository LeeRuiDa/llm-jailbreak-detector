...
\begin{itemize}
  ...
  \item \textbf{LoRA detector.} A Hugging Face sequence classifier fine-tuned through LoRA adapters and loaded from a local run directory. The final Week~7 run uses a DeBERTa-v3-base backbone.
\end{itemize}
