...
\begin{figure}[t]
  ...
  \caption{ROC curve for \texttt{week7\_norm\_only} on \texttt{test\_jbb\_adv2}. The red marker shows the transferred validation threshold $\tau = 0.7340$; the low-FPR inset shows the same operating point in the regime that matters for deployment, where it still remains far from a usable benign-error region.}
