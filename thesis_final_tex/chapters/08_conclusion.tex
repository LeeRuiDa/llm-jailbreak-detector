...
\textbf{RQ3: How does a fully offline rules baseline compare to an optional learned detector under the same decision interface and constraints?}
...
The final contribution set is specific and defensible:
\begin{enumerate}
